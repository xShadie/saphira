...
void CPythonPlayer::SetOfflineShopVID(DWORD dwVID, BYTE bState)
{
	m_dwOfflineShopVID = dwVID;
	m_bOfflineShopState = bState;
}
#endif
...
void CPythonPlayer::Clear()
{
	...
	__ClearAutoAttackTargetActorID();
#ifdef ENABLE_OFFLINE_SHOP
	m_dwOfflineShopVID = 0;
	m_bOfflineShopState = 0;
#endif
}
