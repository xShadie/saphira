...
PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_OPTIMIZATION", 0);
	...
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_EQUIPMENT_INITIAL__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_EQUIPMENT_INITIAL__", 0);
#endif
#ifdef ENABLE__DELETE_ITEM__
	PyModule_AddIntConstant(poModule, "ENABLE__DELETE_ITEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE__DELETE_ITEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_TIME_EXTENDER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_TIME_EXTENDER", 0);
#endif

#ifdef ENABLE_NEW_LOADING
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_LOADING", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_LOADING", 0);
#endif
