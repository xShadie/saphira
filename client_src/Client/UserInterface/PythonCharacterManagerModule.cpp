...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "NAMECOLOR_OFFLINE_SHOP_OWN", CInstanceBase::NAMECOLOR_OFFLINE_SHOP_OWN);
	PyModule_AddIntConstant(poModule, "NAMECOLOR_OFFLINE_SHOP_LOCKED", CInstanceBase::NAMECOLOR_OFFLINE_SHOP_LOCKED);
	PyModule_AddIntConstant(poModule, "EFFECT_MY_OFFLINE_SHOP", CInstanceBase::EFFECT_MY_OFFLINE_SHOP);
#endif
