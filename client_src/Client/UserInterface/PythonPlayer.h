...
class CPythonPlayer : public CSingleton<CPythonPlayer>, public IAbstractPlayer
{
	...
	private:
		DWORD	m_dwOfflineShopVID;
		BYTE	m_bOfflineShopState;
	public:
		void	SetOfflineShopVID(DWORD dwVID, BYTE bState);
		bool	IsOwnOfflineShop(DWORD dwVID) { return m_dwOfflineShopVID == dwVID; }
		BYTE	GetOfflineShopState() { return m_bOfflineShopState; }
#endif
