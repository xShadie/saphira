...
#ifdef ENABLE_LITTLE_PACK
DWORD lololoi1 = atoi(std::string("1315372976").c_str());
DWORD lololoi2 = atoi(std::string("794489237").c_str());
DWORD lololoi3 = atoi(std::string("801517894").c_str());
DWORD lololoi4 = atoi(std::string("1713823941").c_str());
DWORD lololoi5 = atoi(std::string("311353291").c_str());
DWORD lololoi6 = atoi(std::string("3113822941").c_str());
static DWORD s_adwEterPackKey[] = {lololoi1, lololoi2, lololoi3, lololoi4, lololoi5, lololoi6};


DWORD lololod1 = atoi(std::string("863477475").c_str());
DWORD lololod2 = atoi(std::string("1862163843").c_str());
DWORD lololod3 = atoi(std::string("1593296447").c_str());
DWORD lololod4 = atoi(std::string("1385753640").c_str());
DWORD lololod5 = atoi(std::string("0113291").c_str());
DWORD lololod6 = atoi(std::string("301122941").c_str());
static DWORD s_adwEterPackSecurityKey[] = {lololod1, lololod2, lololod3, lololod4, lololod5, lololod6};
#else
...
bool CEterPack::Get(CMappedFile& out_file, const char * filename, LPCVOID * data)
{
	...
	out_file.Create(m_stDataFileName.c_str(), data, index->data_position
#ifdef ENABLE_LITTLE_PACK
	+m_dataOff
#endif
	, index->data_size);
