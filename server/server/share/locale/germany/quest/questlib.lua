...
apply_human = {
	...
	[5] = {"STR", "STR", ""},
	[6] = {"DEX", "DEX", ""},
	[7] = {"ATT_SPEED", "Velocidad de ataque", "%"},
	[8] = {"MOV_SPEED", "Velocidad de movimiento", "%"},
	[9] = {"CAST_SPEED", "Velocidad de hechizo", "%"},
	[10] = {"HP_REGEN", "Regeneracion de HP", "%"},
	[11] = {"SP_REGEN", "Regeneracion de SP", "%"},
	[12] = {"POISON_PCT", "Probabilidad de envenenar", "%"},
	[13] = {"STUN_PCT", "Probabilidad de apagon", "%"},
	[14] = {"SLOW_PCT", "Probabilidad de retardar", "%"},
	[15] = {"CRITICAL_PCT", "Probabilidad de golpes criticos", "%"},
	[16] = {"PENETRATE_PCT", "Probabilidad de golpes de penetracion", "%"},
	[17] = {"ATTBONUS_HUMAN", "Fuerza contra humanos", "%"},
	[18] = {"ATTBONUS_ANIMAL", "Fuerza contra animales", "%"},
	[19] = {"ATTBONUS_ORC", "Fuerza contra orcos", "%"},
	[20] = {"ATTBONUS_MILGYO", "Fuerza contra misticos", "%"},
	[21] = {"ATTBONUS_UNDEAD", "Fuerza contra nomuertos", "%"},
	[22] = {"ATTBONUS_DEVIL", "Fuerza contra demonios", "%"},
	[23] = {"STEAL_HP", "Probabilidad de absorber HP", "%"},
	[24] = {"STEAL_SP", "Probabilidad de absorber SP", "%"},
	[25] = {"MANA_BURN_PCT", "Probabilidad de robar SP al enemigo", "%"},
	[26] = {"DAMAGE_SP_RECOVER", "Probabilidad de recuperar SP al golpear", "%"},
	[27] = {"BLOCK", "Probabilidad de bloquear ataques al cuerpo", "%"},
	[28] = {"DODGE", "Probabilidad de evitar flechas", "%"},
	[29] = {"RESIST_SWORD", "Defensa de espada", "%"},
	[30] = {"RESIST_TWOHAND", "Defensa de dos manos", "%"},
	[31] = {"RESIST_DAGGER", "Defensa de daga", "%"},
	[32] = {"RESIST_BELL", "Defensa de campana", "%"},
	[33] = {"RESIST_FAN", "Defensa  de fan", "%"},
	[34] = {"RESIST_BOW", "Resistencia de flechas", "%"},
	[35] = {"RESIST_FIRE", "Resistencia a fuego", "%"}, 
	[36] = {"RESIST_ELEC", "Resistencia relampago", "%"},
	[37] = {"RESIST_MAGIC", "Defensa magica", "%"},
	[38] = {"RESIST_WIND", "Resistencia a viento", "%"},
	[39] = {"REFLECT_MELEE", "Probabilidad de reflectar ataques al cuerpo", "%"},
	[40] = {"REFLECT_CURSE", "Probabilidad de disipar", "%"},
	[41] = {"POISON_REDUCE", "Resistencia al veneno", "%"},
	[42] = {"KILL_SP_RECOVER", "Probabilidad de recuperar SP al matar", "%"},
	[43] = {"EXP_DOUBLE_BONUS", "Probabilidad de doble bonus de EXP", "%"},
	[44] = {"GOLD_DOUBLE_BONUS", "Probabilidad de doble caida de Yang", "%"},
	[45] = {"ITEM_DROP_BONUS", "Probabilidad de doble caida de objetos", "%"},
	[46] = {"POTION_BONUS", "Potion bonus", ""},
	[47] = {"KILL_HP_RECOVER", "Probabilidad de recuperar HP al matar", "%"},
	[48] = {"IMMUNE_STUN", "Defensa contra apagon", ""},
	[49] = {"IMMUNE_SLOW", "Defensa contra retardo", ""},
	[50] = {"IMMUNE_FALL", "Defensa contra caidas", ""},
	[51] = {"SKILL", "Habilidad", ""},
	[52] = {"BOW_DISTANCE", "Distancia de arco", ""},
	[53] = {"ATT_GRADE_BONUS", "Ataque", ""},
	[54] = {"DEF_GRADE_BONUS", "Defensa", ""},
	[55] = {"MAGIC_ATT_GRADE", "Ataque magico", ""},
	[56] = {"MAGIC_DEF_GRADE", "Defensa magica", ""},
	[57] = {"CURSE_PCT", "Probabilidad de maldecir", "%"},
	[58] = {"MAX_STAMINA", "Max. Stamina", ""},
	[59] = {"ATTBONUS_WARRIOR", "Fuerza contra guerreros", "%"},
	[60] = {"ATTBONUS_ASSASSIN", "Fuerza contra ninjas", "%"},
	[61] = {"ATTBONUS_SURA", "Fuerza contra suras", "%"},
	[62] = {"ATTBONUS_SHAMAN", "Fuerza contra chamanes", "%"},
	[63] = {"ATTBONUS_MONSTER", "Fuerza contra monstruo", "%"},
	[64] = {"MALL_ATTBONUS", "Ataque", "%"},
	[65] = {"MALL_DEFBONUS", "Defensa", "%"},
	[71] = {"DANO_HABILIDAD", "Dano de Habilidad", "%"},
	[72] = {"DANO_MEDIA", "Dano de Media", "%"},
	[73] = {"SKILL_DEFEND_BONUS", "Resistencia de habilidad", "%"},
	[74] = {"NORMAL_HIT_DEFEND_BONUS", "Resistencia de media", "%"},
	[78] = {"RESIST_WARRIOR", "Defensa contra guerreros", "%"},
	[79] = {"RESIST_ASSASSIN", "Defensa contra ninjas", "%"},
	[80] = {"RESIST_SURA", "Defensa contra suras", "%"},
	[81] = {"RESIST_SHAMAN", "Defensa contra chamanes", "%"},
	[94] = {"ATTBONUS_WOLFMAN", "Fuerza contra licanos", "%"},
	[95] = {"RESIST_WOLFMAN", "Defensa contra licanos", "%"},
}
