					...
					(
						{
							...
							"x" : X_GAP + 4,
							"y" : 10,
							"default_image" : ROOT_PATH + "war/warrior_f_overout.tga",
							"over_image" : ROOT_PATH + "war/warrior_f_overin.tga",
							"down_image" : ROOT_PATH + "war/warrior_f_selected.tga",
							#"children" :
							#(
							#	{ 
						...
						{
							"name" : "ASSASSIN_FEMALE",
							"type" : "radio_button",
							"x" : X_GAP + 4,
							"y" : 10 + SELECT_BTN_GAP,
							"default_image" : ROOT_PATH + "ninja/ninja_f_overout.tga",
							"over_image" : ROOT_PATH + "ninja/ninja_f_overin.tga",
							"down_image" : ROOT_PATH + "ninja/ninja_f_selected.tga",
							#"children" :
							#(
							#	{ 
						...
						},
						{
							...
							"default_image" : ROOT_PATH + "sura/sura_f_overout.tga",
							"over_image" : ROOT_PATH + "sura/sura_f_overin.tga",
							"down_image" : ROOT_PATH + "sura/sura_f_selected.tga",
							#"children" :
							#(
							#	{ 
						...
						},
						{
							...
							"default_image" : ROOT_PATH + "shaman/shamano_f_overout.tga",
							"over_image" : ROOT_PATH + "shaman/shamano_f_overin.tga",
							"down_image" : ROOT_PATH + "shaman/shamano_f_selected.tga",
							#"children" :
							#(
							#	{ 
					...
					(
						{
							...
							"x" : X_GAP + 4,
							"y" : 10,
							"default_image" : ROOT_PATH + "war/warrior_m_overout.tga",
							"over_image" : ROOT_PATH + "war/warrior_m_overin.tga",
							"down_image" : ROOT_PATH + "war/warrior_m_selected.tga",
							#"children" :
							#(
							#	{ 
							#		"name" : "CharacterFace_0",
						...
						},
						{
							...
							"x" : X_GAP + 4,
							"y" : 10 + SELECT_BTN_GAP,
							"default_image" : ROOT_PATH + "ninja/ninja_m_overout.tga",
							"over_image" : ROOT_PATH + "ninja/ninja_m_overin.tga",
							"down_image" : ROOT_PATH + "ninja/ninja_m_selected.tga",
							#"children" :
							#(
							#	{ 
							#		"name" : "CharacterFace_1",
						...
						},
						{
							...
							"x" : X_GAP + 4,
							"y" : 10 + SELECT_BTN_GAP*2,
							"default_image" : ROOT_PATH + "sura/sura_m_overout.tga",
							"over_image" : ROOT_PATH + "sura/sura_m_overin.tga",
							"down_image" : ROOT_PATH + "sura/sura_m_selected.tga",
							#"children" :
							#(
							#	{ 
							#		"name" : "CharacterFace_2",
						...
						},
						{
							...
							"x" : X_GAP + 4,
							"y" : 10 + SELECT_BTN_GAP*3,
							"default_image" : ROOT_PATH + "shaman/shamano_m_overout.tga",
							"over_image" : ROOT_PATH + "shaman/shamano_m_overin.tga",
							"down_image" : ROOT_PATH + "shaman/shamano_m_selected.tga",
							#"children" :
							#(
							#	{ 
							#		"name" : "CharacterFace_3",
