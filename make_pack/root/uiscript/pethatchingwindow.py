	...
	(
		{
			...
			(
				# Pet Hatching Window Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":0, "text":uiscriptlocale.PET_HATCHING_TITLE, "all_align":"center" },
					),
				},
				...
				## Pet Hatching Money
				{
					...
					"children" :
					(
						{"name":"HatchingMoney", "type":"text", "x":0, "y":0, "text": uiscriptlocale.PET_HATCHING_PRICE, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "all_align" : "center"},
					),
				},
				...
				## Pet Hatching Button
				{
					...
					"text" : uiscriptlocale.PET_HATCHING,
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":0, "text":uiscriptlocale.PET_HATCHING_NAME, "all_align" : "center"},
					),
				},
			),				
		},
